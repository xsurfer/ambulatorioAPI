...
class Paziente(models.Model):
    ...
    cellulare = models.CharField(max_length=25, null=True, blank=True)
    email = models.EmailField(max_length=254, unique=False, null=True, blank=True)
    profilo = models.TextField(max_length=1000, null=True, blank=True)
...
class Visita(models.Model):
    ...
    anamnesi = models.TextField(max_length=1000, null=True, blank=True)
    esame_obiettivo = models.TextField(max_length=1000, null=True, blank=True)
    esame_strumentale = models.TextField(max_length=1000, null=True, blank=True)
    diagnosi = models.TextField(max_length=1000, null=True, blank=True)
    terapia = models.TextField(max_length=1000, null=True, blank=True)
